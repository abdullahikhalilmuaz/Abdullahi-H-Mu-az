...
import Navbar from "../app/my-portfolio/components/Navbar";
import { ThemeProvider } from "../app/my-portfolio/utils/ThemeContext";
  ...
  return (
    <ThemeProvider>
      <Head>
        ...
        <meta
          name="keywords"
          content="full-stack developer, web developer, React, Node.js, JavaScript, Blockchain Developer"
        />
        ...
        <meta property="og:url" content="https://muazdevy.com" />
        <meta property="og:image" content="https://muazdevy.com/og-image.jpg" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta
          name="twitter:title"
          content="Mu'az Devy - Full-Stack Developer | Block Chain Developer"
        />
        <meta
        ...
        <meta
          name="twitter:description"
          content="Block Chain developer | DApp - DeFi."
        />
        <meta
          name="twitter:image"
          content="https://muazdevy.com/twitter-image.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              skills: "Block Chain Developer",
              url: "https://muazdevy.com",
              sameAs: [
                "https://github.com/abdullahikhalilmuaz/",
                "https://linkedin.com/in/muazdevy",
                "https://twitter.com/muazdevy",
              ],
              knowsAbout: [
                "JavaScript",
                "React",
